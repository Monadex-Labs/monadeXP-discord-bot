...
const mode = process.env.NODE_ENV ; // Check if running in development mode
...
const testGuildId = process.env.TEST_GUILD_ID; // Specific guild ID for testing or guild-specific commands
